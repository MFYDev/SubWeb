  ...
  data() {
    return {
      ...
      options: {
        ...
        customBackend: {
          "vpn.mfy.world (MFYDev)": "https://vpn.mfy.world/sub?",
          "本地 (localhost)":
            "http://127.0.0.1:25500/sub?",
        },
        backendOptions: [
          { value: "https://vpn.mfy.world/sub?" },
	  { value: "http://127.0.0.1:25500/sub?" }
        ...
        remoteConfig: [
            ...
            options: [
	      {
                label: "ACL4SSR精简版",
                value:
                  "https://raw.githubusercontent.com/MFYDev/MFYRuleSet/master/Clash/config/ACL4SSR_Online_Mini.ini"
              },
	      {
                label: "ACL4SSR精简版 更多去广告",
                value:
                  "https://raw.githubusercontent.com/MFYDev/MFYRuleSet/master/Clash/config/ACL4SSR_Online_Mini_AdblockPlus.ini"
              },
	      {
                label: "ACL4SSR精简版 不带自动测速",
                value:
                  "https://raw.githubusercontent.com/MFYDev/MFYRuleSet/master/Clash/config/ACL4SSR_Online_Mini_NoAuto.ini"
              },
	      {
                label: "ACL4SSR精简版 带故障转移",
                value:
                  "https://raw.githubusercontent.com/MFYDev/MFYRuleSet/master/Clash/config/ACL4SSR_Online_Mini_Fallback.ini"
              },
	      {
                label: "ACL4SSR精简版 全功能",
                value:
